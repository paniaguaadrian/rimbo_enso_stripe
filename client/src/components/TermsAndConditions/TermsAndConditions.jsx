...
const TermsAndConditions = () => {
  return (
    <div className="terms-conditions-container">
      ...
      <p>
        Estos términos y condiciones generales (el “<b>Acuerdo”</b> o las “
        <b>Condiciones Generales</b>”) rigen su acceso a{" "}
        <a href="https://rimbo.rent/" blank="true">
          https://rimbo.rent/
        </a>{" "}
      ...
      <ol className="list-lower-alpha">
        ...
        <li>
          <b>Obligaciones Cubiertas:</b> tendrá el significado atribuido en la
          Cláusula 6.2.
        </li>
        <li>
      ...
      <h3>
        6.2{" "}
        <span>Obligaciones Cubiertas y Valor de la Autorización de Cargo</span>
      </h3>
      <p>Las Obligaciones Cubiertas se limitarán a:</p>
      <ol className="list-lower-roman">
        <li>
      ...
      <h3>
        10.1.2{" "}
        <span>
          Incumplimiento del pago después de la ejecución del Aval a Primer
          Requerimiento
        </span>
      </h3>
      <p>
      ...
      <h3>
        11.1 <span>Obligaciones de Rimbo:</span>
      </h3>
      <ol className="list-lower-alpha">
        <li>
      ...
      <ol className="list-lower-alpha">
        ...
        <li>
          Facilitar todos los datos personales e información necesaria sobre los
          Métodos de Pago;
        </li>
        <li>
          Mantener la información personal actualizada, informando
          proactivamente a Rimbo de cualquier cambio en los datos de contacto
          (número de teléfono, correo electrónico, etc.);
        </li>
        <li>
          No cancelar ninguno de los Métodos de Pago durante el Plazo de
          Autorización de Cargo a menos que proporcione un método de pago
          alternativo;
        </li>
        <li>
        ...
        <li>
          Aceptar que se compartan sus datos personales con terceros si así lo
          requieren estas Condiciones Generales;
        </li>
        <li>
      ...
      <p>
        Como contraprestación por los Servicios, Rimbo cobrará del Arrendador
        las tarifas que acuerden en cada momento.
      </p>
      ...
      <p>
        ...
        y/o contractuales derivadas de su tratamiento, siempre debidamente
        protegidos.
      </p>
      <h2>14. PLAZO Y TERMINACIÓN</h2>
      <h3>
        14.1 <span>Plazo</span>
      </h3>
      <p>
        Este Acuerdo entrará en vigor tras su aceptación y permanecerá en vigor
      ...
      <p>
        Este Acuerdo puede ser rescindido en caso de que ocurra cualquiera de
        las siguientes situaciones:
      </p>
      <ol className="list-lower-alpha">
        <li>
          Confirmación por parte del Arrendador de que el check-out se ha
          realizado con éxito y que no existen responsabilidades adicionales;
        </li>
        <li>
          Sesenta (60) días después de la terminación del Contrato de
          Arrendamiento;
        </li>
        <li>
          Unilateralmente por Rimbo con un preaviso de treinta (30) días,
          siempre que exista:
          <ol className="list-lower-roman">
            <li>
              Confirmación de que la Autorización de Cargo ha sido cancelada por
              el Arrendador;
            </li>
            <li>
              Incumplimiento de cualquiera de las manifestaciones y garantías
      ...
      <p>
        ...
        propósitos de dicha disposición, deba subsistir tras la terminación o
        expiración de este Acuerdo, se considerará que subsiste durante el
        tiempo que sea necesario para cumplir con tales propósitos.
      </p>
      ...
      <ol className="list-lower-alpha">
        <li>
          ...
          sujeto a legislación que regule la insolvencia, bancarrota, moratoria
        ...
        <li>
          ...
          sujeto de un procedimiento penal pendiente (excluyendo infracciones de
          tráfico y otros delitos menores).
        </li>
      </ol>
      <h3>
        15.2 <span>Manifestaciones y garantías del Arrendador:</span>
      </h3>
      ...
      <p>Las actividades prohibidas incluyen, pero no se limitan a:</p>
      <ol className="list-lower-alpha">
        <li>actividad penal o ilícita;</li>
        <li>
          recuperación sistemática de datos u otro contenido de la Plataforma;
        </li>
        <li>
          crear o compilar, directa o indirectamente, una colección,
          compilación, base de datos o directorio sin el permiso por escrito de
          Rimbo;
        </li>
        <li>
          hacer cualquier uso no autorizado de la Plataforma, incluyendo la
          recopilación de nombres de usuario y/o direcciones de correo
          electrónico de los usuarios, o la creación de cuentas de usuario por
          medios automatizados o bajo falsas pretensiones;
        </li>
        <li>
          engañar, defraudar o confundir a Rimbo y a otros usuarios,
          especialmente en cualquier intento de adquirir información sensible de
          cuentas, como contraseñas;
        </li>
        <li>
          realizar cualquier uso automatizado del sistema, como el uso de
          cualquier minería de datos, robots o herramientas similares de
          recopilación y extracción de datos;
        </li>
        <li>
          interferir, interrumpir o crear una carga indebida en la Plataforma o
          en las redes o servicios conectados a los Servicios;
        </li>
        <li>
          intentar hacerse pasar por otro usuario o persona o usar el nombre de
          usuario de otro usuario;
        </li>
        <li>vender o transferir su Perfil;</li>
        <li>
          utilizar cualquier información obtenida de los Servicios con el fin de
          acosar, abusar de o dañar a otra persona;
        </li>
        <li>
          utilizar los Servicios como parte de cualquier esfuerzo para competir
          con Rimbo;
        </li>
        <li>
          descifrar, descompilar, desmontar o realizar ingeniería inversa de
          cualquiera de los programas que comprenden o que de alguna manera
          conforman una parte de los Servicios;
        </li>
        <li>
          intentar eludir cualquier medida de los Servicios diseñada para
          impedir o restringir el acceso a la Plataforma, o a cualquier parte de
          la Plataforma;
        </li>
        <li>
          acosar, molestar, intimidar o amenazar a cualquier empleado o agente
          de Rimbo que se dedique a prestarle cualquier parte de los Servicios;
        </li>
        <li>
          eliminar el aviso de derechos de autor u otros derechos de propiedad
          de cualquier contenido de la Plataforma, excepto como resultado del
          uso estándar del motor de búsqueda o del navegador de Internet,
          utilizando o lanzando, desarrollando o distribuyendo cualquier sistema
          automatizado, incluyendo, sin limitación, cualquier spider, robot (o
          “bot”), herramienta de estafa, extractor de información o lector fuera
          de línea que acceda a los Servicios, o el uso o lanzamiento de
          cualquier script no autorizado u otro software; o utilizar la
          Plataforma de una manera incompatible con todas y cada una de las
          leyes y regulaciones aplicables.
        </li>
      </ol>
      <h2>17. DERECHOS DE PROPIEDAD INTELECTUAL</h2>
      <p>
        Todos los derechos relativos al contenido publicado por nosotros en la
        Plataforma están protegidos por derechos de autor y derechos de
        propiedad intelectual e industrial. Somos responsables de la propiedad
        de la Plataforma relacionada con dicho contenido y destacamos que ha
        sido desarrollado y creado por nosotros, y que contamos con todas las
        licencias y permisos oportunos para hacer uso de cualquier contenido
      ...
      <p>
        ...
        nuestra, o de las personas o empresas que han autorizado expresamente su
        publicación; o son propiedad de personas o empresas que están sujetas a
        licencias que nos permiten utilizar estos elementos.
      </p>
      <p>
        Sin nuestro consentimiento expreso por escrito, la reproducción,
        transformación, distribución, comunicación pública, puesta a disposición
        del público, venta o cualquier otro uso que no sea el expresamente
        autorizado por nosotros en las políticas y otros avisos publicados en
        nuestra Plataforma, ya sean comerciales o de otro tipo, están
        expresamente prohibidos, cuando este uso implique la explotación de
        contenidos de una manera diferente a la prevista.
      </p>
      <p>
        Rimbo es el propietario y legítimo titular de: (i) el dominio
        <a href="www.rimbo.rent">www.rimbo.rent</a>; y (ii) la marca ‘RIMBO’. El
        Arrendatario no puede utilizar la marca Rimbo, el nombre de dominio, el
        eslogan ni ningún otro elemento que constituya nuestra identidad
        corporativa sin solicitar permiso expreso.
      </p>
      <h2>18. PROTECCIÓN DE DATOS</h2>
      <p>
        Rimbo se compromete a cumplir con lo dispuesto en el Reglamento (UE)
        2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016
        (RGPD) y en la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de
      ...
      <p>
        Los datos se conservarán hasta la terminación de la relación
        contractual, y una vez haya terminado, por el período legalmente
        requerido para el cumplimiento de cualquier obligación legal. Tenga en
        cuenta que, en algunos casos, podremos conservar sus datos durante el
        tiempo necesario para ejercer o defender reclamaciones, requisitos,
        responsabilidades y obligaciones legales y/o contractuales derivadas del
        tratamiento, siempre debidamente bloqueados.
      </p>
      <p>
        Los datos personales no serán divulgados a terceros sin su
        consentimiento expreso. Sin embargo, dependiendo de los fines para los
        que se recopile la información personal, se podrá acceder a dicha
      ...
      <h2>19. LIMITACIONES DE LA RESPONSABILIDAD DE RIMBO</h2>
      <p>
        Rimbo no será responsable en ningún caso por los siguientes conceptos,
      ...
      <ol className="list-lower-alpha">
        ...
        <li>
          ...
          eliminaciones o transmisiones incompletas, ya que puede haber caídas
          en la red u otras situaciones de las que Rimbo no sea directamente
          responsable, dado que Rimbo no es responsable ni puede garantizar que
          la Plataforma estará siempre operativa, y por lo tanto está exento de
        ...
        <li>
          ...
          haya sido informado con antelación o respecto del cual no se hayan
          adoptado las medidas apropiadas cuando el responsable de los datos sea
          un tercero; es decir, cuando nosotros actuemos como encargado del
          tratamiento y, como tal, debamos cumplir con nuestras propias
          obligaciones y responsabilidades en virtud de las disposiciones de la
          legislación aplicable en materia de protección de datos.
        </li>
        <p>
          Rimbo no será considerado responsable en ningún caso de la legitimidad
          de las reclamaciones del Arrendador, o de los cobros abusivos,
          ilícitos o malintencionados del Arrendador.
        </p>
        <h2>20. MODIFICACIONES DE ESTAS CONDICIONES GENERALES</h2>
        <p>
          Rimbo podrá realizar cambios y/o modificaciones a estas Condiciones
          Generales a su entera discreción cuando lo considere conveniente y/o
          necesario.
        </p>
        <p>
      ...
      <p>
        En el caso de que cualquier cláusula de estas Condiciones Generales sea
        declarada nula, el resto de las cláusulas seguirán siendo válidas y se
        interpretarán teniendo en cuenta los deseos de las partes y el propósito
        de estas Condiciones Generales, y la cláusula en cuestión se considerará
        inaplicable.
      </p>
      <p>
      ...
      <p>
        Estas Condiciones Generales se rigen por la legislación española. Para
        determinar el lugar donde se prestan los Servicios, nos adheriremos a lo
        dispuesto en el artículo 29 de la Ley 34/2002, de 11 de julio, de
        Servicios de la Sociedad de la Información y de Comercio Electrónico.
      </p>
      <p>
        Así, en caso de conflicto o discrepancia en la interpretación o
        aplicación de estas Condiciones Generales, los Juzgados y Tribunales
        que, en su caso, conocerán el caso serán los establecidos por la
      ...
      <p>
        En cumplimiento de lo dispuesto en el Reglamento 524/2013, del
      ...
      <p>
        Mediante dicho enlace puede acceder a entidades alternativas de
        resolución de conflictos con procedimientos de calidad establecidos para
        este fin. Esta plataforma multilingüe está diseñada para ser accesible
      ...
      <p>
        ...
        Una vez que se acuerde la entidad de mediación, esta tratará el caso
        digitalmente, proponiendo una resolución en un plazo de 90 días.
      </p>
    </div>
  );
};
